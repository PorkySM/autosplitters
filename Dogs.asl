...
state("Pcdogs", "EU") {
	byte state : 0x9FA80;
	int levelEnd : 0x168D360;
	int levelID : 0x168D9B0;
	int bossStage : 0x168D9A0, 0x1C, 0x70;
}
...
startup {
	...
	settings.Add("game_version_sc", false, "Scandinavian", "game_version");
        settings.Add("game_version_eu", false, "European", "game_version");
...
init {
	...
	} else if (settings["game_version_eu"]) {
		version = "EU";
		vars.firstEntityOffset = 0x23765C;
	}
